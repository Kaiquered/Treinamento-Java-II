...
/*Programa que calcula o salário líquido de um funcionário e aumenta seu salário baseado
na quantia bruta.
*/
...
public class ProgramEmployee1 {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Updated data: %s, $ %.2f", employee.name,employee.increaseSalary(percentage/100));
